...
SNS: amodule.o cnamemodule.o soamodule.o config.o ipfilter.o dnspacket.o server.o main.o 
	g++ Build/amodule.o Build/cnamemodule.o Build/soamodule.o Build/config.o Build/ipfilter.o Build/dnspacket.o Build/server.o Build/main.o -o Build/SNS 
